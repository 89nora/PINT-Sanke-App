...
export function initalizePointsOfInterest() {
      addPointOfInterest(55.685536, 12.572966, 2000, 'Æbler');
      addPointOfInterest(55.700011, 12.569528, 2000, 'Hyldeblomst');
      addPointOfInterest(55.670802, 12.520449, 2000, 'Karl Johan Svampe');
      addPointOfInterest(55.671907, 12.613360, 2000, 'Kirsebær');
      addPointOfInterest(55.653841, 12.575903, 2000, 'Jordbær');
};
